  ...
  <div class="saas-layout" role="main">
    ...
    <nav class="sidebar" role="navigation" aria-label="Main Sidebar">
      ...
      <div class="nav-section" role="tablist" aria-label="Main Tabs">
        ...
        <a href="#" class="nav-item" role="tab" :aria-selected="activeTab==='intelligence'" :class="{active: activeTab==='intelligence'}" @click.prevent="activeTab='intelligence'"><span class="icon">🧠</span> <span style="flex:1;">Intelligence</span><div v-if="syncingTabs['intelligence'] || state?.working_on === 'learn' || state?.working_on === 'qdd'" class="sync-spinner" aria-hidden="true"></div></a>
