...
// AIAdapter defines the interface that all AI assistants must implement
// to natively support the QDD framework commands.
type AIAdapter interface {
	Name() string
	Sync(projectPath string) error
}

// QDDCommandProtocol defines the standard instructions injected into AI agents.
const QDDCommandProtocol = `
